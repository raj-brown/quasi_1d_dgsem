...
p_inflow() = 9.753431315656933e04 
p_outflow() = 9.277211161772543e04
...
matwrite("sol_subsonic.mat", Dict( "x" => x_p, "pressure" => p_p, "Ma" => Ma); compress = true)
